        ...
        <div className="container-page grid gap-12 lg:grid-cols-[.84fr_1.16fr]">
          ...
          <div className="border-y border-white/15">
            {groups.map((group, index) => (
              <ScrollReveal key={group.title} animation="fade-up" delay={index * 50}>
                <article className="grid gap-4 border-b border-white/10 py-6 transition-colors duration-200 hover:bg-white/[0.02] hover:pl-2 rounded-sm sm:grid-cols-[3.2rem_11rem_1fr] sm:gap-6 last:border-b-0">
