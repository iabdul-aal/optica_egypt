...
const reasons = [
  "Meet people who care about the same questions.",
  "Find talks, resources, and learning opportunities.",
  "Build relationships across Egypt's photonics community.",
]
...
export default function JoinPage() {
  return (
    <>
      <PageHeader
        eyebrow="Join Optica Egypt"
        title="Your next connection could change your trajectory."
        intro="Membership is open to students, researchers, faculty, professionals, and anyone excited by the science and application of light."
      />
        ...
        <div className="container-page grid gap-12 lg:grid-cols-[.82fr_1.18fr]">
          <div>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-7 sm:gap-9">
              <a href={siteConfig.joinFormUrl} target="_blank" rel="noreferrer" className="btn-primary">
                Open membership form <ArrowUpRight size={14} />
              </a>
