  ...
  return (
    <section className="section-space border-y border-white/10 bg-[#0d1011]">
      <div className="container-page">
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[.82fr_1.18fr] lg:items-start">
          ...
          <div className="relative min-h-[330px] py-1">
            <div className="scientific-grid absolute inset-0 opacity-40" aria-hidden="true" />
            <div className="relative flex h-full flex-col">
              <div className="flex flex-wrap items-start justify-between gap-4">
                ...
                <span className="font-mono text-[0.62rem] tracking-[0.14em] text-[var(--gold)]">CONCEPTUAL MODEL</span>
              </div>
