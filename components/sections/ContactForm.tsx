...
export function ContactForm() {
  ...
  return (
    <div className="reticle-box p-8 md:p-10 bg-[#010E17]">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">{t("form_title")}</h2>
        <span className="text-[10px] font-mono text-[#00e660]">ENCRYPTED // FORMSPREE READY</span>
      </div>
      ...
      {isSuccess ? (
        <div className="p-6 bg-[#00e660]/10 border border-[#00e660]/30 flex items-start gap-3.5 text-[#00e660]">
